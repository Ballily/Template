...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select ID,AdminName,isActive from admin where  AdminuserName='$uname' && Password='$Password' ");
...
<body class="bg-gradient-primary">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
			...
			<div class="col-xl-10 col-lg-12 col-md-9"><div><br></div>
                <?php $query=mysqli_query($con,"select * from site");
while($row=mysqli_fetch_array($query)){
$logo=$row['siteLogo']; 
$wtitle=$row['siteTitle'];
}  ?>
<p align="center">
      <img src="../assets/<?php echo $logo;?>"  width="80"> </p>
