  ...
  if (isset($_POST['submit'])) {
    ...
    if (!in_array($extension, $allowed_extensions) && !empty($imgfile)) {
      ...
      if (!empty($imgfile)) {
        ...
        unlink($currentppath);
        $sql = mysqli_query($con, "update site set siteLogo='$imgnewfile', siteTitle='$wtitle'");
      } else {
        $sql = mysqli_query($con, "update site set siteTitle='$wtitle'");
      }
      $status = 1;
      mysqli_query($con, "insert into logs(userName, userIp, userAction, actionUrl, actionStatus) values('$uname', '$uip', '$action', '$link', '$status')");
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <img src="../assets/<?php echo $row['siteLogo'];?>" width="250">
                                        </div>
                                        <div class="form-group">
